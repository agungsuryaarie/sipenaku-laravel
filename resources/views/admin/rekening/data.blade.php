                ...
                <div class="card-body">
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-10">
                                <div>: {{ $subkegiatan->kegiatan->kode_kegiatan }}
                                    {{ $subkegiatan->kegiatan->nama_kegiatan }}</div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-2">
                            ...
                            <div class="col-10">
                                <div>: {{ $subkegiatan->kode_sub }} {{ $subkegiatan->nama_sub }}</div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-2">
                            ...
                            <div class="col-10">
                                <div>: {{ $subkegiatan->kegiatan->bagian->nama_bagian }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('subkegiatan.index', $subkegiatan->kegiatan->id) }}" id="createNewSubkeg"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="hidden" id="id_subkeg" name="id_subkeg" value="{{ $subkegiatan->id }}">
                                    <label>Kegiatan</label>
                                    <input type="text" class="form-control"
                                        placeholder="{{ $subkegiatan->kegiatan->kode_kegiatan }} {{ $subkegiatan->kegiatan->nama_kegiatan }}"
                                        disabled>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                        placeholder="{{ $subkegiatan->kode_sub }} {{ $subkegiatan->nama_sub }}" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="row">
    ...
    <script>
        $(function() {
            ...
            $("body").on("click", ".editRekening", function() {
                var rekening_id = $(this).data("id_subkeg");
                $.get("{{ route('rekening.index', $subkegiatan->id) }}" + "/" + rekening_id + "/edit",
                    function(data) {
                        $("#modelHeading").html("Edit Rekening");
                        $("#saveBtn").val("edit-rekening");
                        $("#ajaxModel").modal("show");
                        $("#rekening_id").val(data.id);
                        $("#id_subkeg").val(data.id_subkeg);
