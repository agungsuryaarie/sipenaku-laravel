<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-wf-domain="spectrum-template.webflow.io"
    data-wf-page="638ff800599a0466379d5480" data-wf-site="638ff800599a0427a59d547f">
...
<head>
    ...
    <meta
        ...
        name="description" />
    <meta content="Spectrum - Webflow HTML website template" property="og:title" />
    <meta
        content="Spectrum Webflow template is highly suitable for creating websites for mobile applications, startups, software apps, blockchain, SaaS, and technology businesses."
        property="og:description" />
    <meta content="Spectrum - Webflow HTML website template" property="twitter:title" />
    <meta
        content="Spectrum Webflow template is highly suitable for creating websites for mobile applications, startups, software apps, blockchain, SaaS, and technology businesses."
...
<body>
    ...
    <footer class="section-footer wf-section">
        ...
        <div data-w-id="ef2d27af-e28a-9c66-8e12-40322fccb395" style="opacity: 0" class="gradient-footer">
            <div class="noise"></div>
        </div>
    </footer>
