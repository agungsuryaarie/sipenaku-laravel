        ...
        <div class="container-fluid" data-aos="fade-up">
            <div class="row justify-content-center">
                ...
                <div class="col-xl-4 col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="150">
                    <img src="{{ url('front/assets/img/ilustrasi.png') }}" class="img-fluid animated" alt="">
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 order-1 order-lg-1" data-aos="zoom-in" data-aos-delay="150">
                        <img src="{{ url('front/assets/img/logobb.png') }}" class="img-fluid" alt="">
                    </div>
                    <div class="col-lg-4 pt-4 pt-lg-0 order-2 order-lg-2 content" data-aos="fade-right">
                        <h3>Visi Pemerintah Kab.Batu Bara</h3>
                        <p class="fst-italic">
                    ...
                    <div class="col-lg-4 pt-4 pt-lg-0 order-2 order-lg-2 content" data-aos="fade-right">
                        <h3>Misi Pemerintah Kab.Batu Bara</h3>
                        <p class="fst-italic">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                            labore et dolore
                            magna aliqua.
